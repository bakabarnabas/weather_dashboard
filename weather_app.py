...
if st.session_state.weather_data and st.session_state.city_meta:
    ...
    with tab1:
        ...
        fig_temp.update_layout(
            ...
            yaxis=dict(title="°C", gridcolor="#1e3a5f", color="#60efff", titlefont=dict(color="#60efff")),
            yaxis2=dict(title="%", overlaying="y", side="right", gridcolor="rgba(0,0,0,0)", color="#4a9eff", titlefont=dict(color="#4a9eff")),
